...
MEM_BehavioralMatch1_FILE="sub-"$PARTIC""_task-MemMatch1_run-01_events
MEM_BehavioralMatch2_FILE="sub-"$PARTIC""_task-MemMatch2_run-01_events
MEM_BehavioralMatch3_FILE="sub-"$PARTIC""_task-MemMatch3_run-01_events

MEM_BehavioralRepeat1_FILE="sub-"$PARTIC""_task-MemRepeat1_run-01_events
MEM_BehavioralRepeat2_FILE="sub-"$PARTIC""_task-MemRepeat2_run-01_events
MEM_BehavioralRepeat3_FILE="sub-"$PARTIC""_task-MemRepeat3_run-01_events
