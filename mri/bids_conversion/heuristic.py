...
def infotodict(seqinfo):
    T1w = create_key('sub-{subject}/anat/sub-{subject}_acq-MPRAGE_run-{item:02d}_T1w')
    dwi_ap = create_key('sub-{subject}/dwi/sub-{subject}_acq-71AP_run-{item:02d}_dwi')
    dwi_pa = create_key('sub-{subject}/dwi/sub-{subject}_acq-71PA_run-{item:02d}_dwi')
    REST = create_key('sub-{subject}/func/sub-{subject}_task-REST_run-{item:02d}_bold')
    MemMatch1 = create_key('sub-{subject}/func/sub-{subject}_task-MemMatch1_run-{item:02d}_bold')
    MemMatch2 = create_key('sub-{subject}/func/sub-{subject}_task-MemMatch2_run-{item:02d}_bold')
    MemMatch3 = create_key('sub-{subject}/func/sub-{subject}_task-MemMatch3_run-{item:02d}_bold')
    MemRepeat1 = create_key('sub-{subject}/func/sub-{subject}_task-MemRepeat1_run-{item:02d}_bold')
    MemRepeat2 = create_key('sub-{subject}/func/sub-{subject}_task-MemRepeat2_run-{item:02d}_bold')
    MemRepeat3 = create_key('sub-{subject}/func/sub-{subject}_task-MemRepeat3_run-{item:02d}_bold')
    CSGT1 = create_key('sub-{subject}/func/sub-{subject}_task-CSGT1_run-{item:02d}_bold')
    CSGT2 = create_key('sub-{subject}/func/sub-{subject}_task-CSGT2_run-{item:02d}_bold')
    PHD1 = create_key('sub-{subject}/func/sub-{subject}_task-PHD1_run-{item:02d}_bold')
    PHD2 = create_key('sub-{subject}/func/sub-{subject}_task-PHD2_run-{item:02d}_bold')
