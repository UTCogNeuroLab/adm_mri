...
oa_data %>%
  ...
  stat_smooth(aes(x = fact, y = value)) +
  facet_wrap (. ~ variable, scales = "free_y") + 
  ylab("z-score") +
...
oa_data %>%
  ...
  stat_smooth(aes(x = sleep_time, y = value)) +
  facet_wrap (. ~ variable, scales = "free_y") + 
  ylab("z-score") +
...
oa_data %>%
  ...
  stat_smooth(aes(x = sleep_efficiency, y = value)) +
  facet_wrap (. ~ variable, scales = "free_y") + 
  ylab("z-score") +
...
oa_data %>%
  ...
  stat_smooth(aes(x = actalph, y = value)) +
  facet_wrap(. ~ variable, scales = "free_y") + 
  ylab("z-score") +
...
ya_data %>%
  ...
  theme_minimal() +
  geom_point(aes(x = fpn_participation_x, y = value)) +
  stat_smooth(aes(x = fpn_participation_x, y = value)) +
  facet_wrap (. ~ variable, scales = "free_y") + 
  ylab("z-score") +
  ggtitle("FPN Participation and Neuropsych Measures")
```
...
oa_data %>%
  ...
  stat_smooth(aes(x = value, y = fpn_participation_x)) +
...
oa_data %>%
  ...
  stat_smooth(aes(x = value, y = dmn_participation_x)) +
  xlab("rest-activity measure") +
  facet_wrap (. ~ variable, scales = "free_x")
```
