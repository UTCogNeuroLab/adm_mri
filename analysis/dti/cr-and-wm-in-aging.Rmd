...
lm1 <- lm(cc_fa ~ actamp + age + cc_vol + Group, data = d)
summary(lm1)
...
summary(lm(cc_fa ~ actamp + Group + age + cc_vol + total_ac_mean_active + efficiency_mean_sleep, data = d))
summary(lm(cc_fa ~ actamp + Group + cc_vol + total_ac_mean_active + efficiency_mean_sleep, data = d)) 
summary(lm(cc_fa ~ actamp + Group + cc_vol, data = d)) 
summary(lm(cc_fa ~ actamp + Group + cc_vol + age, data = d)) 
